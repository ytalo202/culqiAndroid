package com.example.oportuna.culqiandroid;
...
import com.example.oportuna.culqiandroid.Culqui.Card;
import com.example.oportuna.culqiandroid.Culqui.Token;
import com.example.oportuna.culqiandroid.Culqui.TokenCallback;
import com.example.oportuna.culqiandroid.Validation.Validation;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnPay.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                ...
                Card card = new Card("4111111111111111",
                       "123", 9,
                        2020, txtemail.getText().toString());

                Token token = new Token("pk_test_CtWWUhEyRQUBLA9r");
